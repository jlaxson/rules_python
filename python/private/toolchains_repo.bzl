...
alias(name = "py3_runtime",     actual = platform_target(":py3_runtime"))
alias(name = "python_headers",  actual = platform_target(":python_headers"))
alias(name = "python_runtimes", actual = platform_target(":python_runtimes"))
alias(name = "python3",         actual = select({{":" + item : "@" + item + "//:" + ("python.exe" if "windows" in item else "bin/python3") for item in PLATFORMS.keys()}}))
""".format(
